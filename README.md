...
<img src='https://github.com/TeannaP18/InstagramClone/blob/main/walkthrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

My application build was not failing but when I ran the app it seemed to freeze whenever I pressed the login button. Originally the app was working fine but once I
